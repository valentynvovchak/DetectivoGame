...
import DiInteresting from "../assets/sprites/SVG детектив женщина заинтересованность готовый  25.08.25..svg";
import MaiFoundTheCar from "../assets/sprites/SVG готовый свидетель нашла машину 31.08.svg";
...
export const getSprite = (name: string) => {
    switch (name) {
        ...
        case "di_without_cape":
            ...
            // return require("../assets/sprites/SVG детектив женщина заинтересованность готовый  25.08.25. 1.svg");
        case "di_interesting":
            // return require("../assets/sprites/SVG детектив женщина заинтересованность готовый  25.08.25..svg");
            return DiInteresting;
        case "mai_found_the_car":
            // return require("../assets/sprites/SVG готовый свидетель нашла машину 31.08.svg");
